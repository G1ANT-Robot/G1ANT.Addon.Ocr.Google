...
namespace G1ANT.Language.Ocr.Google
{
    ...
    public class OcrGoogleFindPointCommand : Command
    {
        ...
        {
            var screenArea = arguments.Relative.Value ? arguments.Area.Value.ToAbsoluteCoordinates() : arguments.Area.Value;
            ...
            var point = new Point(rectangle.Value.X + arguments.Area.Value.X, rectangle.Value.Y + arguments.Area.Value.Y);            
